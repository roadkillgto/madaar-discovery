export const madaarSites = [
    ...
    },
    {
        ...
        name: "Non-Emergency Sand Recovery",
    ...
    },
    {
        ...
        name: "Dark Sky Protocol: Meteor Shower",
        provider: "Al Qua'a Farmers Cooperative",
        description: "Community reminder for participating farms to reduce non-essential perimeter lighting during major stargazing events.",
        status: "Protocol Active",
        contactLink: "community-board"
    }
];
...
export const localGuidance = [
    ...
    },
    {
        ...
        answer: "Some sites are reachable by normal car. Deeper desert sites may require a 4x4 — check with your specific host before visiting."
    },
    {
